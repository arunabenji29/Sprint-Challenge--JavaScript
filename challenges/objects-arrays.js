...
const uni = [];
for (let i = 0; i < graduates.length; i++) {
  if (/Uni/.test(graduates[i].university)) {
...
populationTotal = zooAnimals.reduce((acc, curValue) => {
  return acc + curValue.population }, 0);
